...
export default function LinkList({ link, links }: Sanity.LinkList) {
	return (
		...
		>
			...
			<ul className="anim-fade-to-b md:frosted-glass top-full left-0 border-neutral-400 px-3 py-2 max-md:border-l md:absolute md:min-w-max md:rounded md:border md:bg-white md:shadow-md">
				{links?.map((link, key) => (
					<li key={key}>
