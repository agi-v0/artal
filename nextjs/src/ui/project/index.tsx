			...
			<section>
				<div className="mx-auto max-w-7xl border-x border-b p-8 lg:py-32">
					<div className="max-w-2xl">
						<h1 className="text-foreground/50 mt-6 text-2xl">
							{project.client}
						</h1>
						<div className="mt-12 max-w-sm">
							...
							<div>
								services:{' '}
								<span className="text-foreground/50">{project.services}</span>
							</div>
							<div>
								Year: <span className="text-foreground/50">{project.year}</span>
							</div>
						</div>
					</div>
				</div>
			...
			<section>
				<div className="mx-auto max-w-7xl border-x border-b p-8">
					<div className="inline-flex w-full items-center justify-between">
						<div>
							<span className="text-foreground/50 font-light">Work</span>
