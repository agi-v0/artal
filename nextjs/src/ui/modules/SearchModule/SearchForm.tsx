	...
	return (
		<search className={cn(css.root, 'relative', className)} {...props}>
			...
			{query && (
				...
				>
					<div className="frosted-glass mt-1 max-h-[20em] overflow-y-auto rounded border border-neutral-400 bg-white shadow-md">
						<p className="text-foreground/50 line-clamp-1 p-2 text-center text-sm">
