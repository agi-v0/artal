		...
		<section className="section border-b-0 p-0">
			{(pretitle || intro) && (
				<header className="richtext p-site text-center text-balance">
					<Pretitle className="mx-auto border-none p-0">{pretitle}</Pretitle>
			...
			<div className="relative">
				...
				>
					{allLogos.map((logo, key) => (
						<div className="group flex h-[104px] w-full shrink-0 items-center justify-center bg-[size:10px_10px] object-contain hover:bg-[image:repeating-linear-gradient(315deg,_var(--pattern-fg)_0,_var(--pattern-fg)_1px,_transparent_0,_transparent_50%)]">
							<Img
				...
				<div
					aria-hidden="true"
					className="*: pointer-events-none absolute bottom-0 grid w-full grid-cols-2 border-t *:border-e *:border-b md:grid-cols-3 lg:grid-cols-4"
				>
					{allLogos.map((logo, key) => (
						<div
