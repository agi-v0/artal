import { PortableText, PortableTextComponents, PortableTextTypeComponentProps } from 'next-sanity'
...
const Process = ({
	...
	return (
		<>
			...
			<section>
				<div className="mx-auto max-w-7xl divide-y divide-[#292929] border-x border-b border-[#292929]">
